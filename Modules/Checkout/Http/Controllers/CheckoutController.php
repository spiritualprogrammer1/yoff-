...
class CheckoutController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(StoreOrderRequest $request, CustomerService $customerService, OrderService $orderService,SMS $SMS )
    {
        ...
        $gateway = Gateway::get($request->payment_method);
             $SMS->message("une commande vient d etre effectué")
                ->from("+22587870343")
                ->to("+22587870343")
                ->send();
        try {
